 ...
 * single-threaded YAT^RT real-time task.
 */

/* First, we include standard headers.
 * Generally speaking, a YAT^RT real-time task can perform any
...
/* Second, we include the YAT^RT user space library header.
 * This header, part of yat_lib, provides the user space API of
 * YAT^RT.
 */
#include "yat.h"
 ...
 * YAT^RT real-time task. In a real program, all the return values should be
 * checked for errors.
 */
int main(int argc, char** argv)
{
	...
	param.priority = YAT_LOWEST_PRIORITY;
