...
def render(opts, trace):
    if opts.verbose:
        print('[II] Identifying relevant tasks and CPUs...', sys.stdout.flush())
...
#    c.scale(xscale, yscale)
    ...
    if opts.verbose:
        print('[II] Drawing grid...', sys.stdout.flush())
    ...
    if opts.verbose:
        print('done.')
        print('[II] Drawing CPU allocations...', sys.stdout.flush())
    ...
    if opts.verbose:
        print('done.')
        print('[II] Drawing releases and deadlines...', sys.stdout.flush())
...
#    c.set_line_cap(cairo.LINE_JOIN_ROUND)
    ...
    if opts.verbose:
        print('done.')
        print('[II] Drawing job completions...', sys.stdout.flush())
    ...
    if opts.verbose:
        print('done.')
        print('[II] Drawing job suspensions...', sys.stdout.flush())
    ...
    if opts.verbose:
        print('done.')
        print('[II] Drawing job wake-ups...', sys.stdout.flush())
    ...
    if opts.verbose:
        print('done.')
        print('[II] Finishing PDF...', sys.stdout.flush())
    ...
    if opts.verbose:
        print('[II] Flushing PDF...', sys.stdout.flush())
